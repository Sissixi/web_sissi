...
if __name__ == '__main__':
    ...
    ele = bp.click_element((By.XPATH, '//iframe[contains(@id,"ueditor_")]'), "应约弹框_应约回复输入框")
    bp.switch_to_iframe(ele, "切换iframe_应约回复输入框")
    time.sleep(1)
    bp.click_element((By.XPATH, '//span[contains(text(),"1、文案调整：")]'),"点击输入")
    # time.sleep(2)
    bp.input_text((By.XPATH, '//span[contains(text(),"1、文案调整：")]'),"输入内容","点击输入")
    time.sleep(1)
